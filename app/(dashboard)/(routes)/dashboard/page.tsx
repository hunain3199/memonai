...
const DashboardPage = () => {
  ...
  return (
    <div>
      <div className='mb-8 space-y-4 px-4 md:px-0'>
        <h2 className='text-2xl md:text-4xl font-bold text-center'>Explore the Power Of Memon AI Platform</h2>
      ...
      <div className='px-4 md:px-20 lg:px-32 space-y-4'>
        {tools.map((tool)=>(
          ...
          className='p-[14px] border-black/5 flex items-center
